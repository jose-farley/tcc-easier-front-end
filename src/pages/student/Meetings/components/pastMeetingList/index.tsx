...
export function PastMeetingList() {
    ...
    useEffect(() => {
        ...
        const pastMeetings = listMeetings.filter((el) => compareDateTime(el.due));
    ...
    if(pastMeetingList.length > 0){
        return (
                <ContainerActualTasks>
                    <Subtitle>Reuniões passadas</Subtitle>
                    <Tabela>
                        <thead>
                            <tr>
                            <th>Aluno</th>
        ...
        return (
            <ContainerActualTasks>
                <Subtitle>Reuniões passadas</Subtitle>
                <Message>Nenhuma reunião anterior encontrada.</Message>   
            </ContainerActualTasks>
        )
    }
}